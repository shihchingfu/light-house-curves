...
lc1 <- generate_example_gp(periodic_kernel, 
  ...
  mutate(series = "A") |> 
  arrange(t) |> 
  mutate(y = f + rnorm(n = N_points*1, 0, y_se),
         is_visible = ifelse(t %% (1/obs_cadence) == 0, TRUE, FALSE), # based on observing cadence
         non_detection = sample(x = c(TRUE, FALSE), size = N_points*1, # non-detections
...
lc |> 
  ...
  labs(x = "Time (minutes)", 
       y = "Brightness", 
       title = "Lighthouse Characteristics - Continuous", 
       colour = "Lighthouse") +
...
lc |> 
  ...
  labs(x = "Time (minutes)", 
       y = "Brightness", 
       title = "Lighthouse Characteristics - Discretised", 
       colour = "Lighthouse") +
  theme( strip.text.x = element_blank() )
```
...
lc |> 
  ...
  labs(x = "Time (minutes)", 
       y = "Brightness",
       title = "Lighthouse Characteristics - Noisy", 
       colour = "Lighthouse") +
  theme( strip.text.x = element_blank() )
```
...
lc |> 
  ...
  labs(x = "Time (minutes)", 
       y = "Brightness", 
       title = "Lighthouse Characteristics - Visible", 
       colour = "Lighthouse") +
  theme( strip.text.x = element_blank() )
```
...
lc |> 
  ...
  labs(x = "Time (minutes)", 
       y = "Brightness", 
       title = "Lighthouse Characteristics - Detected", 
       colour = "Lighthouse", 
       alpha = "Observed") +
...
lc |> 
  ...
  labs(x = "Time (minutes)",
       y = "Brightness", 
       title = "Lighthouse Characteristics - Observed", 
       colour = "Lighthouse") +
  theme( strip.text.x = element_blank() )
```
